...
print("4:", isleap(4), calendar.isleap(4))
print("100:", isleap(100), calendar.isleap(100))
print("400:", isleap(400), calendar.isleap(400))
print("900:", isleap(900), calendar.isleap(900))
print("2020:", isleap(2020), calendar.isleap(2020))
